...
//定义拦截网址
static NSString *const old1 = @"https://down.anticheatexpert.com/iedsafe/Client/ios/2131/0AEE5282/comm.dat";
static NSString *const new1 = @"http://www.6igg.com/config/config2.txt";
static NSString *const old2 = @"https://down.anticheatexpert.com/iedsafe/Client/ios/2131/1EEE921C/mrpcs.data";
static NSString *const new2 = @"http://www.6igg.com/config/config2.txt";
static NSString *const old3 = @"https://down.anticheatexpert.com/iedsafe/Client/ios/2131/config2.xml";
static NSString *const new3 =@"https://150.138.83.59/2.xml";
static NSString *const old4 =@"https://down.anticheatexpert.com/iedsafe/Client/ios/2131/config3.xml";
static NSString *const new4 = @"https://150.138.83.59/3.xml";
static NSString *const old5 = @"https://idcconfig.gcloud.qq.com/";
static NSString *const new5 = @"*bpu";
static NSString *const old6 = @"https://szmg.qq.com";
static NSString *const new6 = @"*bpu";
static NSString *const old7 = @"https://api.unipay.qq.com";
static NSString *const new7 = @"*bpu";
static NSString *const old8 = @"https://nggproxy.3g.qq.com/";
static NSString *const new8 = @"*bpu";
static NSString *const old9 = @"https://idcconfig.gcloud.qq.com/";
static NSString *const new9 = @"*bpu";
static NSString *const old10 = @"https://idcconfig.gcloud.qq.com/";
static NSString *const new10 = @"*bpu";
static NSString *const old11 = @"https://nggproxy.3g.qq.com/";
static NSString *const new11 = @"*bpu";
static NSString *const old12 = @"http://mazu.3g.qq.com/";
static NSString *const new12 = @"*bpu";
static NSString *const old13 = @"https://stat.tpns.sh.tencent.com";
static NSString *const new13 = @"*bpu";
static NSString *const old14 = @"http://guid.guid.tpns.sh.tencent.com";
static NSString *const new14 = @"*bpu";
static NSString *const old15 = @"http://stat.guid.tpns.sh.tencent.com";
static NSString *const new15 = @"*bpu";
static NSString *const old16 = @"http://log.guid.tpns.sh.tencent.com";
static NSString *const new16 = @"*bpu";
static NSString *const old17 = @"https://gpcloud.tgpa.qq.com";
static NSString *const new17 = @"*bpu";
static NSString *const old18 = @"http://cloudctrl.gcloud.qq.com";
static NSString *const new18 = @"*bpu";
static NSString *const old19 = @"http://ios.bugly.qq.com";
static NSString *const new19 = @"*bpu";
static NSString *const old20 = @"configsvr.msf.3g.qq.com/";
static NSString *const new20 = @"*bpu";
static NSString *const old21 = @"jsonatm.broker.tplay.qq.com/";
static NSString *const new21 = @"*bpu";
static NSString *const old22 = @"huatuocode.huatuo.qq.com/";
static NSString *const new22 = @"*bpu";
static NSString *const old23 = @"configsvr.msf.3g.qq.com";
static NSString *const new23 = @"*bpu";
static NSString *const old24 = @"tplay.qq.com";
static NSString *const new24 = @"*bpu";
static NSString *const old25 = @"http://data.flurry.com";
static NSString *const new25 = @"*bpu";
static NSString *const old26 = @"http://safebrowsing.urlsec.qq.com";
static NSString *const new26 = @"*bpu";
static NSString *const old27 = @"https://img.ssl.msdk.qq.com";
static NSString *const new27 = @"*bpu";
static NSString *const old28 = @"http://oth.eve.mdt.qq.com";
static NSString *const new28 = @"*bpu";
static NSString *const old29 = @"myqcloud.com/";
static NSString *const new29 = @"*bpu";
static NSString *const old30 = @"https://livew.l.qq.com/";
static NSString *const new30 = @"*bpu";
static NSString *const old31 = @"gamesafe.qq.com/";
static NSString *const new31 = @"*bpu";
static NSString *const old32 = @"https://hpjy-op.tga.qq.com/";
static NSString *const new32 = @"*bpu";
static NSString *const old33 = @"https://stat.tpns.sh.tencent.com/device/api/GetOfflineMsg";
static NSString *const new33 = @"*bpu";
static NSString *const old34 = @"https://info.zb.video.qq.com/";
static NSString *const new34 = @"*bpu";
static NSString *const old35 = @"https://down.anticheatexpert.com/iedsafe/Client/ios/2131/1C8710C6/tssmua.zip";
static NSString *const new35 = @"http://www.6igg.com/config/config2.txt";
...
static NSString *const new43 = @"http://59.47.73.201/1.png";
static NSString *const old44 = @"thirdwx.qlogo.cn/";
static NSString *const new44 = @"http://59.47.73.201/1.png";
